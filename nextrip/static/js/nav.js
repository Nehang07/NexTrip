...
function renderAuthUI() {
    ...
    slot.innerHTML = `
      <div class="nav-avatar-wrap">
        ...
        <div class="nav-dropdown" id="nav-dropdown">
          ...
          <a href="planner.html">My trips</a>
  ...
  document.dispatchEvent(new CustomEvent('nehang-auth-ready', { detail: { user: CURRENT_USER } }));
}
...
async function submitRegister(e) {
  ...
  closeAuthModal();
  renderAuthUI();
  showToast(`Welcome to Nehang Planner, ${data.name.split(' ')[0]}!`);
  if (typeof onAuthChanged === 'function') onAuthChanged();
  return false;
}
